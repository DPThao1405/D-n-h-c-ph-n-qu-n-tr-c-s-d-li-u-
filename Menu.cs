...
namespace quan_tri_tiem_nha_nhung
{
    public partial class Menu : Form
    {
        ...
        {
            command = connection.CreateCommand();
            command.CommandText = "insert into MONAN values(dbo.AddMonAn(),N'" + textBox6.Text + "',N'" + comboBox2.Text + "',N'" + numericUpDown1.Text + "')";
        ...
        {
            command = connection.CreateCommand();
            command.CommandText = "update MONAN set TenMon=N'" + textBox6.Text + "',DVT='" + comboBox2.Text + "',DonGia_Mon='" + numericUpDown1.Text + "' where MaNV='" + textBox1.Text + "'";
